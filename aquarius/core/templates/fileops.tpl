...
<div class="bigbox">
    ...
    <input type="text" class="ef" name="pattern" value=""/>
...
<div class="bigbox">
    ...
    <i>{$root_dir}</i><input type="text" class="ef" name="src" value="{$smarty.request.src|escape}" />

    <br /><br />
    <div class="bigboxtitle"><h2>{#dircopy_dest#}</h2></div>
    <i>{$root_dir}</i><input type="text" class="ef" name="dst" value="{$smarty.request.dst|escape}"/>
...
<div class="bigbox">
    ...
    <i>{$root_dir}</i><input type="text" class="ef" name="path" value="{$smarty.request.path|escape}" />
    for all files and directories in this path. DANGEROUS!
    <br /><br />
    <div class="bigboxtitle"><h2>Desired mode</h2></div>
    <input type="text" class="ef" name="mode" value="{$smarty.request.mode|default:"0700"|escape}"/>
