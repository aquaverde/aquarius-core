...
/** Creates select-field for countries
  ...
  */
function smarty_function_getcountryname($params, &$smarty) {
    
    $country_code = strtoupper(get($params, 'code'));
    $lg = get($params, 'lg');
    
    
    if($lg == 'de')
    {
            $country_codes = array ( 'AL' => 'Albanien',
                'DZ' => 'Algerien',
                'AS' => 'American samoa',
                'AD' => 'Andorra',
                'AO' => 'Angola',
    ...
    {
             $country_codes = array ( 'AL' => 'Albania',
                'DZ' => 'Algeria',
                'AS' => 'American samoa',
                'AD' => 'Andorra',
                'AO' => 'Angola',
